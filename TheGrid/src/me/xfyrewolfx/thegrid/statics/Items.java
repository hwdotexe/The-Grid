...
public class Items {
	...
	public static ItemStack adwareVirusSHOP(){
		...
		im.setDisplayName("§bAdware Virus §6($5 BTC)");
		List<String> lore = new ArrayList<String>();
		lore.add("§7Adware forces advertisements on the");
		lore.add("§7target, generating EXP and Bitcoin");
	...
	public static ItemStack killdiscVirusSHOP(){
		...
		im.setDisplayName("§bKilldisc Virus §6($8 BTC)");
		List<String> lore = new ArrayList<String>();
	...
	public static ItemStack iceSHOP(){
		...
		im.setDisplayName("§bIce §6($3 BTC)");
		List<String> lore = new ArrayList<String>();
	...
	public static ItemStack cryptolockerVirus(){
		...
		List<String> lore = new ArrayList<String>();
		lore.add("§7Encrypts the target computer,");
		lore.add("§7generating EXP and Bitcoin");
